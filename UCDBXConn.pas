...
uses
  System.SysUtils, System.Classes, UCBase, Data.DB, SqlExpr, SimpleDS;

type
  TUCDBXConn = class(TUCDataConn)
  private
...
procedure TUCDBXConn.Notification(AComponent: TComponent;
...
begin
  try
    ...
    if SchemaName <> '' then FConnection.GetTableNames(TempList, SchemaName)
    else FConnection.GetTableNames(TempList);
