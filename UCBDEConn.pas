...
uses
  System.SysUtils, System.Classes, UCBase, Data.DB, DBTables;

type
  TUCBDEConn = class(TUCDataConn)
  private
...
procedure TUCBDEConn.Notification(AComponent: TComponent;
...
{$IFDEF VER130}
   FDatabase.Session.GetTableNames(FDatabase.Databasename,'*.db*', False, False, Lista);
{$ELSE}
